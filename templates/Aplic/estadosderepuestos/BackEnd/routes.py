...
# Local: solo export_pdf (lógica específica de esta app)
...
def _redirigir(return_to, tab_activo):
    ...
    if return_to == 'indexinventario.indexinventario':
        return redirect(url_for('indexinventario.indexinventario'))
...
def estado_filter():
    ...
    return render_template(
        ...
        tabs=tabs,
        tab=tab_activo,
        active_tab=tab_activo.get('sanitized_id', ''),
